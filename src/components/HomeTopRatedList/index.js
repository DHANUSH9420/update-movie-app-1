...
class HomeTopRatedList extends Component {
  ...
  getTopRated = async () => {
    ...
    const api = 'https://apis.ccbp.in/movies-app/top-rated-movies'
            ...
            return (
              <Link to={`/movies/${id}`} key={eachLogo.id} className="link">
                <div className="slick-item">
                  <img src={posterPath} alt={title} className="nav-image" />
                </div>
              </Link>
            )
          })}
...
export default HomeTopRatedList
